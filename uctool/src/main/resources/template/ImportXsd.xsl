...
&lt;uct xmlns="http://uctool.sf.net/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
	...
	xsi:schemaLocation="
		http://uctool.sf.net/ http://uctool.sf.net/xsd/${project.version}/uct.xsd
...
<template match="xs:simpleType">
	...
	<if test="xs:restriction">
		...
		&lt;description>Minimal length: <value-of select="@value" />.<text />
			<if test="xs:annotation/xs:documentation">
				<text> </text>
				<value-of select="normalize-space(string-join(xs:annotation/xs:documentation,' '))" />
			</if>
		...
		&lt;description>Maximal length: <value-of select="@value" />.<text />
			<if test="xs:annotation/xs:documentation">
				<text> </text>
				<value-of select="normalize-space(string-join(xs:annotation/xs:documentation,' '))" />
			</if>
...
<template match="xs:element">
	...
	<if test="count(xs:annotation/xs:documentation) lt 2">
	<text> /></text>
	</if>
